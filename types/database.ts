...
export type AssetCriticality = Database['public']['Enums']['asset_criticality']
export type BusinessSector = Database['public']['Enums']['business_sector']
export type ExposureLevel = Database['public']['Enums']['exposure_level']
...
export type AssetVulnerability = Database['public']['Tables']['asset_vulnerabilities']['Row']
